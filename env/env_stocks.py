...
class StockEnv(gym.Env):
    ...
    def __init__(self,
       ...
       # How many days trading for
        self.day = day
        self.initial_data = initial_data
        self.data = initial_data
        # Number of stocks you are considering
        self.stock_dim = stock_dim
        # Max number of a single stock you can trade
        self.hmax = hmax
        # Initial amount to invest
        self.initial_amount = initial_amount
        # Transaction costs: Can set these based on real life
        self.buy_cost_pct = buy_cost_pct
        self.sell_cost_pct = sell_cost_pct
        # Something having to do with training
        self.reward_scaling = reward_scaling
        # The dimension of the state space: 1 + 2*stock_dimension + len(config.TECHNICAL_INDICATORS_LIST)*stock_dimension
        self.state_space = state_space
        # Actions you can take depends on number of stocks and how many shares you can buy
